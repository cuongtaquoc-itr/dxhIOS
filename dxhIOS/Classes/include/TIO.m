...
NSInteger const TIO_MAX_UART_DATA_SIZE_PRO = 237;
NSInteger const TIO_MAX_UART_CREDITS_COUNT = 64;
...
+ (NSString *)pathWithFileName:(NSString *)fileName
{
    ...
    NSString *pathName = [NSString stringWithFormat:@"%@-%@", appBundleId, fileName];
